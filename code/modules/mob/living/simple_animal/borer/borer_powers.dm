...
/mob/living/simple_animal/borer/verb/secrete_chemicals()
	...
	var/list/choices = list("Inaprovaline" = /singleton/reagent/inaprovaline, "Bicaridine" = /singleton/reagent/bicaridine, "Kelotane" = /singleton/reagent/kelotane, "Dylovene" = /singleton/reagent/dylovene, "Hyperzine" = /singleton/reagent/hyperzine, "Peridaxon" = /singleton/reagent/peridaxon, "Tramadol" = /singleton/reagent/mortaphenyl, "Neurapan" = /singleton/reagent/mental/neurapan) // NEW HORIZONS EDIT CHANGE - Chemical rename: Mortaphenyl -> Tramadol
