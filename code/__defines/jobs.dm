...
#define SCC_ROLES list(COMMAND_ROLES, COMMAND_SUPPORT_ROLES, EQUIPMENT_ROLES, OFF_DUTY_CREW_MEMBER_ROLE, SECURITY_ROLES, MEDICAL_ROLES, ENGINEERING_ROLES, REPRESENTATIVE_ROLE) //New Horizons Edit
#define NT_ROLES list(SCIENCE_ROLES, MEDICAL_ROLES, SERVICE_ROLES, CIVILIAN_ROLES, REPRESENTATIVE_ROLE)
#define PMC_ROLES list(SECURITY_ROLES, MEDICAL_ROLES, CIVILIAN_ROLES, COMMAND_ROLES, COMMAND_SUPPORT_ROLES, SCIENCE_ROLES, REPRESENTATIVE_ROLE) //New Horizons Edit
