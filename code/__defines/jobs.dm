...
#define PMC_ROLES list(SECURITY_ROLES, MEDICAL_ROLES, CIVILIAN_ROLES, COMMAND_SUPPORT_ROLES, SCIENCE_ROLES, ENGINEERING_ROLES, REPRESENTATIVE_ROLE) //New Horizons Edit
...
#define ORION_ROLES list(OPERATIONS_ROLES, CIVILIAN_ROLES, COMMAND_SUPPORT_ROLES, SERVICE_ROLES, REPRESENTATIVE_ROLE) //New Horizons Edit
