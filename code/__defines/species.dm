...
#define SPECIES_TAJARA_ZHAN			"Zhan Tajara" //NEW HORIZONS EDIT
#define SPECIES_TAJARA_MSAI			"M'sai Tajara"
#define SPECIES_TAJARA_TESLA_BODY	"Tesla Rejuvenation Suit Tajara"
#define SPECIES_TAJARA_OFFWORLD		"Off-Worlder Tajara" //NEW HORIZONS EDIT
...
#define ALL_SPECIES list(SPECIES_HUMAN, SPECIES_HUMAN_OFFWORLD, SPECIES_IPC, SPECIES_IPC_BISHOP, SPECIES_IPC_G1, \
			...
			SPECIES_TAJARA_MSAI, SPECIES_TAJARA_ZHAN, SPECIES_TAJARA_OFFWORLD, SPECIES_UNATHI, SPECIES_VAURCA_WORKER, \
			SPECIES_VAURCA_WARRIOR, SPECIES_VAURCA_BULWARK, SPECIES_VAURCA_BREEDER,) // NEW HORIZONS EDIT CHANGE - SPECIES_TAJARA_OFFWORLD
