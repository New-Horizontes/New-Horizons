...
/obj/item/card/id/merchant
	...
	desc = "An identification card issued to UNIP-sanctioned merchants, indicating their right to sell and buy goods."
	icon_state = "centcom"
...
/obj/item/card/id/synthetic
	...
	desc = "Access module for UNIP equipment."
	icon_state = "id-robot"
	item_state = "tdgreen"
...
/obj/item/card/id/ert
	name = "\improper Emergency Response Team identification card"
	icon_state = "centcom"
	overlay_state = "centcom"
...
/obj/item/card/id/asset_protection
	name = "\improper Asset Protection identification card"
	icon_state = "centcom"
	overlay_state = "centcom"
...
/obj/item/card/id/pmc
	name = "\improper OSS identification card"
	desc = "A high-tech holobadge, identifying the owner as a contractor from one of the many entities that the Office of Special Services contracts from, or a direct employee for The Office."
	icon_state = "pmc_card"
	overlay_state = "pmc_card"
...
/obj/item/card/id/orion
	name = "\improper Charon Shipping identification card"
