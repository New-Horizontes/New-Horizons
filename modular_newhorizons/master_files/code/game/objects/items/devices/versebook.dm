...
/obj/item/device/versebook/tribunal
	...
	desc = "A holy text of the Cassian Holy Tribunal, the state religion of the Empire of Dominia."
...
/obj/item/device/versebook/biesel
	...
	desc = "A common possession by Biesel government officals, the printed text of the constitution for the Federal Republic of Biesel."
...
/obj/item/device/versebook/siakh
	name = "\improper Writings of Sassurism"
	desc = "A collection of musings, commands and theological discussions, copied many times over from the alleged words of the controversial prophet, and final emissary of God, Sassur himself."
	desc_extended = "As close to a 'holy text' as the faith of Sassur has, this book can be found across Zakkeran and beyond, in the hands of its followers, though some bits of it seem familiar to most humans, simply worded differently."
	icon_state = "holybook"
	item_state = "book1"
...
/obj/item/device/versebook/autakh
	...
	desc = "A barely tolerated tome in the Izweski Hegemony, and outright illegaly on Yzali, Reflections is a short book penned by the Akran Unathi known as Emzal Paossini, known by Aut'akh as 'Creator of Paradigms', infamous for their role in the early days of the Aut'akh faith."
	desc_extended = "The Aut'akh faith is highly decentralised and does not have holy texts per se. This book is simply a collection of personal musings from one of the Aut'akh's most influential Paradigms.\
	While many of the core ideas of the faith can be traced back to Paossini's words, they are explicit in their desire that it not be venerated or treated as some divine mandate but merely an interpretation.."
	icon_state = "book10"
	item_state = "book10"
...
/obj/item/device/versebook/skakh
	name = "\improper Ensi legends"
	desc = "This is a collection of legends, commandments and doctrines of the Ensiite faith, one of many variants published by a God-King or their followers."
	desc_extended = "Variations of this tome have been published for centuries, in one form or another, often changing to deal with recent developments for the Unathi people by a regional Ensi. This variation looks to have been published \
	fairly recently, and from a city under the reign of the most famous and cruel God-King of all, Hal-Aman The Eternal"
	icon_state = "book3"
	item_state = "book3"
...
/obj/item/device/versebook/thakh
	name = "\improper assorted Hartism fables"
	desc = "The most pervasive and common religion amongst Yzali Unathi. This book is a collection of common ancient tales and fables, translated into Basic for even more sales."
	desc_extended = "The tales of various Tech-Princes numbered beyond count. This particular copy seems to be written by a particularly egocentric one."
	icon_state = "holybook"
	item_state = "book1"
