...
/obj/item/cane/shaman
	name = "Sassurian staff"
	desc = "A seven foot staff traditionally carried by Zakkeran pastors both as a walking aide and a tool of self-defense. It is made out of dark, polished wood and is curved at the end."
