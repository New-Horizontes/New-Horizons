...
/datum/ghostspawner/human/admin/corporate/ccia_escort
	...
	desc = "Escort OSS agents, watch them annoy the crew and prevent them from throwing themselves under their own shuttle."
...
/datum/ghostspawner/human/admin/corporate/scc_bodyguard
	...
	name = "UNIP Bodyguard"
	desc = "Protect the UNIP agent you're assigned to with your life. In fact, protect them if you die as well, if possible."
...
/datum/ghostspawner/human/admin/corporate/fib
	short_name = "fib"
	name = "DJDA Agent"
	desc = "Investigate issues related to crimes under the jurisdiction of the UN Department of Justice and Diplomatic Affairs."
...
/datum/ghostspawner/human/admin/corporate/fib/escort
	...
	name = "DJDA Escort"
	desc = "Protect the agents of the UN Department of Justice and Diplomatic Affairs while on the field."
