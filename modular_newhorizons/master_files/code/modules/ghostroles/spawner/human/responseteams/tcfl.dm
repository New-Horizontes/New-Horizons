/datum/ghostspawner/human/ert/tcfl
	...
	welcome_message = "The Tau Ceti Foreign Legion officially works for the Republic of Biesel, and unofficially for Nanotrasen; your job is to protect the place you're heading to and fix the problem. You can be a Volunteer (Vol.), Legionnaire (Lgn.) or Prefect (Pfct.). The first option is recommended for new players."
	max_count = 3
