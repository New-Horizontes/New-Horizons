...
/datum/category_item/player_setup_item/general/basic/content(var/mob/user)
	...
	dat += "<br>"
	dat += "<b>Body Type:</b> <a href='?src=\ref[src];gender=1'><b>[capitalize(lowertext(pref.gender))]</b></a><br>" //not all species have assigned sex, this should help avoid confusion. Solely a player-facing change.
	var/datum/species/S = all_species[pref.species]
