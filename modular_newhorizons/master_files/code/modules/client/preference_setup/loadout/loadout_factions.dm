...
// Previously PMCG now OSS
/datum/gear/faction/pmc_sunglasses
	display_name = "OSS security HUD selection"
	description = "A selection of OSS security HUDs."
	path = /obj/item/clothing/glasses/sunglasses/sechud/pmc
	slot = slot_glasses
	allowed_roles = list("Security Officer", "Head of Security", "Warden", "Security Cadet", "Investigator")
	faction = "Office of Special Services"

/datum/gear/faction/pmc_sunglasses/New()
	..()
	var/list/pmc_sunglasses = list()
	pmc_sunglasses["HUDsunglasses, OSS"] = /obj/item/clothing/glasses/sunglasses/sechud/pmc
	pmc_sunglasses["fat HUDsunglasses, OSS"] = /obj/item/clothing/glasses/sunglasses/sechud/big/pmc
	pmc_sunglasses["aviator sunglasses, OSS"] = /obj/item/clothing/glasses/sunglasses/sechud/aviator/pmc
	pmc_sunglasses["HUDsunglasses alt, OSS-C"] = /obj/item/clothing/glasses/sunglasses/sechud/pmc/alt
	pmc_sunglasses["fat HUDsunglasses alt, OSS-C"] = /obj/item/clothing/glasses/sunglasses/sechud/big/pmc/alt
	pmc_sunglasses["aviator sunglasses alt, OSS-C"] = /obj/item/clothing/glasses/sunglasses/sechud/aviator/pmc/alt
	pmc_sunglasses["security HUD, OSS"] = /obj/item/clothing/glasses/hud/security/pmc
	pmc_sunglasses["security HUD, OSS-C"] = /obj/item/clothing/glasses/hud/security/pmc/alt
	gear_tweaks += new /datum/gear_tweak/path(pmc_sunglasses)

/datum/gear/faction/pmc_medglasses
	display_name = "OSS medical HUD selection"
	description = "A selection of OSS medical HUDs."
...
/datum/gear/faction/pmc_medglasses/New()
	..()
	var/list/pmc_sunglasses = list()
	pmc_sunglasses["aviator sunglasses, OSS"] = /obj/item/clothing/glasses/hud/health/aviator/pmc
	pmc_sunglasses["medical HUD, OSS"] = /obj/item/clothing/glasses/hud/health/pmc
	pmc_sunglasses["aviator sunglasses, OSS-C"] = /obj/item/clothing/glasses/hud/health/aviator/pmc/alt
	pmc_sunglasses["medical HUD, OSS-C"] = /obj/item/clothing/glasses/hud/health/pmc/alt
	gear_tweaks += new /datum/gear_tweak/path(pmc_sunglasses)

/datum/gear/faction/pmc_labcoat
	display_name = "OSS labcoat selection"
	description = "A selection of OSS and Contractor labcoats."
...
/datum/gear/faction/pmc_labcoat/New()
	...
	pmc_labcoats["OSS labcoat"] = /obj/item/clothing/suit/storage/toggle/labcoat/pmc
	pmc_labcoats["OSS labcoat, alt"] = /obj/item/clothing/suit/storage/toggle/labcoat/pmc/alt
	pmc_labcoats["OSS labcoat, long"] = /obj/item/clothing/suit/storage/toggle/longcoat/pmc
	pmc_labcoats["OSS-C labcoat"] = /obj/item/clothing/suit/storage/toggle/labcoat/epmc
	pmc_labcoats["OSS employee jacket"] = /obj/item/clothing/suit/storage/toggle/corp/pmc
	pmc_labcoats["OSS-C contractor jacket"] = /obj/item/clothing/suit/storage/toggle/corp/pmc/alt
	pmc_labcoats["OSS winter coat"] = /obj/item/clothing/suit/storage/hooded/wintercoat/pmc
	pmc_labcoats["OSS-C winter coat"] = /obj/item/clothing/suit/storage/hooded/wintercoat/pmc/alt
	gear_tweaks += new /datum/gear_tweak/path(pmc_labcoats)

/datum/gear/faction/pmc_sec_coat
	display_name = "OSS security coat selection"
	description = "A selection of OSS security coats."
...
/datum/gear/faction/pmc_sec_coat/New()
	...
	pmc_sec_coat["OSS security coat"] = /obj/item/clothing/suit/storage/security/officer/pmc
	pmc_sec_coat["OSS security coat, alt"] = /obj/item/clothing/suit/storage/security/officer/pmc/alt
	gear_tweaks += new /datum/gear_tweak/path(pmc_sec_coat)

/datum/gear/faction/pmcg_headwear
	display_name = "OSS and OSS-C headwear selection"
	description = "A selection of OSS and Contractor headwear."
...
/datum/gear/faction/pmcg_headwear/New()
	...
	pmcg_headwear["OSS beret"] = /obj/item/clothing/head/beret/corporate/pmc
	pmcg_headwear["OSS softcap"] = /obj/item/clothing/head/softcap/pmc
	pmcg_headwear["OSS softcap, alt"] = /obj/item/clothing/head/softcap/pmc/alt
	pmcg_headwear["OSS-C beret"] = /obj/item/clothing/head/beret/corporate/pmc/epmc
	pmcg_headwear["OSS-C softcap"] = /obj/item/clothing/head/softcap/pmc/epmc
	pmcg_headwear["OSS woolen hat"] = /obj/item/clothing/head/wool/pmc
	pmcg_headwear["OSS-C woolen hat"] = /obj/item/clothing/head/wool/pmc/alt
	pmcg_headwear["OSS garrison cap"] = /obj/item/clothing/head/sidecap/pmcg
	gear_tweaks += new /datum/gear_tweak/path(pmcg_headwear)

/datum/gear/faction/pmc_modsuit
	display_name = "OSS modsuit"
	description = "A modular OSS fatigue jumpsuit."
	path = /obj/item/clothing/under/pmc_modsuit
	slot = slot_w_uniform
	faction = "Office of Special Services"

/datum/gear/faction/pmcg_sec_uniforms
	display_name = "OSS/OSS-C security uniform selection"
	description = "A selection of OSS and Contractor security uniforms."
...
/datum/gear/faction/pmcg_sec_uniforms/New()
	...
	pmcg_sec_uniforms["OSS uniform"] = /obj/item/clothing/under/rank/security/pmc/pmcsec
	pmcg_sec_uniforms["OSS uniform, alt"] = /obj/item/clothing/under/rank/security/pmc/pmcsec/alt
	pmcg_sec_uniforms["OSS-C uniform"] = /obj/item/clothing/under/rank/security/pmc/epmc
	pmcg_sec_uniforms["OSS-C uniform, alt"] = /obj/item/clothing/under/rank/security/pmc/epmc/alt
	pmcg_sec_uniforms["OSS-C detective uniform"] = /obj/item/clothing/under/det/pmc/alt
	pmcg_sec_uniforms["wildlands squadron contractor uniform"] = /obj/item/clothing/under/rank/security/pmc/wildlands_squadron
	pmcg_sec_uniforms["Dagamuir Freewater contractor uniform"] = /obj/item/clothing/under/rank/security/pmc/dagamuir_freewater
	gear_tweaks += new /datum/gear_tweak/path(pmcg_sec_uniforms)

/datum/gear/faction/erisec_patch
	display_name = "OSS-C sleeve patch"
	path = /obj/item/clothing/accessory/sleevepatch/erisec
	slot = slot_tie
	faction = "Office of Special Services"

/datum/gear/faction/pmc_patch
	display_name = "OSS armband"
...
/datum/gear/faction/pmc_patch/New()
	...
	pmc_patch["OSS armband"] = /obj/item/clothing/accessory/armband/pmc
	pmc_patch["OSS armband, alt"] = /obj/item/clothing/accessory/armband/pmc/alt
	gear_tweaks += new /datum/gear_tweak/path(pmc_patch)

/datum/gear/faction/epmc_uniform_phys_med
	display_name = "OSS physician uniform"
...
/datum/gear/faction/epmc_uniform_pharm_med
	display_name = "OSS pharmacist uniform"
...
/datum/gear/faction/epmc_uniform_psych_med
	display_name = "OSS psychiatrist uniform"
...
/datum/gear/faction/epmc_uniform_intern_med
	display_name = "OSS medical intern uniform"
...
/datum/gear/faction/epmc_uniform_fr_med
	display_name = "OSS/OSS-C first responder uniform"
...
/datum/gear/faction/epmc_uniform_fr_med/New()
	...
	epmc_uniform_fr_med["OSS-C first responder uniform"] = /obj/item/clothing/under/rank/medical/first_responder/pmc/epmc
	epmc_uniform_fr_med["OSS first responder uniform, alt"] = /obj/item/clothing/under/rank/medical/first_responder/pmc/alt
	epmc_uniform_fr_med["Sekhmet Intergalactic contractor first responder uniform"] = /obj/item/clothing/under/rank/medical/first_responder/pmc/sekh
...
/datum/gear/faction/orion_coat
	display_name = "Charon coat selection"
	description = "A selection of Charon coats"
	path = /obj/item/clothing/suit/storage/toggle/labcoat/orion
	slot = slot_wear_suit
	faction = "Charon Shipping Services"

/datum/gear/faction/orion_coat/New()
	..()
	var/list/orion_labcoats = list()
	orion_labcoats["charon labcoat"] = /obj/item/clothing/suit/storage/toggle/labcoat/orion
	orion_labcoats["charon letterman labcoat"] = /obj/item/clothing/suit/storage/toggle/labcoat/orion/letterman
	orion_labcoats["charon labcoat, long"] = /obj/item/clothing/suit/storage/toggle/longcoat/orion
	orion_labcoats["charon corporate jacket"] = /obj/item/clothing/suit/storage/toggle/corp/orion
	orion_labcoats["charon corporate jacket, alt"] = /obj/item/clothing/suit/storage/toggle/corp/orion/alt
	orion_labcoats["charon winter coat"] = /obj/item/clothing/suit/storage/hooded/wintercoat/orion
	orion_labcoats["charon winter coat, alt"] = /obj/item/clothing/suit/storage/hooded/wintercoat/orion/alt
	gear_tweaks += new /datum/gear_tweak/path(orion_labcoats)

/datum/gear/faction/orion_headwear
	display_name = "Charon headwear selection"
	description = "A selection of Charon headwear"
...
/datum/gear/faction/orion_headwear/New()
	...
	orion_headwear["beret, charon"] = /obj/item/clothing/head/beret/corporate/orion
	orion_headwear["charon woolen hat"] = /obj/item/clothing/head/wool/orion
	orion_headwear["charon woolen hat, alt"] = /obj/item/clothing/head/wool/orion/alt
	gear_tweaks += new /datum/gear_tweak/path(orion_headwear)

//SCC now UNIP
/datum/gear/faction/scc_armband
	display_name = "UNIP armband"
...
/datum/gear/faction/scc_sleevepatch
	display_name = "UNIP sleeve patch"
...
/datum/gear/faction/scc_jacket
	display_name = "UNIP coat selection"
	description = "A selection of Protectorate coats"
...
/datum/gear/faction/scc_jacket/New()
	...
	scc_jackets["UNIP jacket"] = /obj/item/clothing/suit/storage/toggle/brown_jacket/scc
	scc_jackets["UNIP leather jacket"] = /obj/item/clothing/suit/storage/toggle/corp/scc
	scc_jackets["UNIP leather jacket, alt"] = /obj/item/clothing/suit/storage/toggle/corp/scc/alt
	scc_jackets["UNIP winter coat"] = /obj/item/clothing/suit/storage/hooded/wintercoat/scc
	scc_jackets["UNIP winter coat, alt"] = /obj/item/clothing/suit/storage/hooded/wintercoat/scc/alt
	gear_tweaks += new /datum/gear_tweak/path(scc_jackets)

/datum/gear/faction/scc_beret
	display_name = "UNIP headwear selection"
	description = "A selection of UNIP headwear"
...
/datum/gear/faction/scc_beret/New()
	...
	scc_headwear["beret, UNIP"] = /obj/item/clothing/head/beret/scc
	scc_headwear["UNIP woolen hat"] = /obj/item/clothing/head/wool/scc
	scc_headwear["UNIP woolen hat, alt"] = /obj/item/clothing/head/wool/scc/alt
