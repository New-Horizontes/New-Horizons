...
/datum/gear/suit/hazard_vest/New()
	...
	hazard["hazard vest, OSS-C blue"] = /obj/item/clothing/suit/storage/hazardvest/blue
...
/datum/gear/suit/dominia_cape/New()
	...
	dominiacape["dominian cape, macgregor"] = /obj/item/clothing/accessory/poncho/dominia_cape/strelitz
	dominiacape["white dominian cape, macgregor"] = /obj/item/clothing/accessory/poncho/dominia_cape/strelitz/white
	dominiacape["dominian cape, prlov"] = /obj/item/clothing/accessory/poncho/dominia_cape/volvalaad
	dominiacape["white dominian cape, orlov"] = /obj/item/clothing/accessory/poncho/dominia_cape/volvalaad/white
	dominiacape["dominian cape, rodrigo"] = /obj/item/clothing/accessory/poncho/dominia_cape/kazhkz
	dominiacape["white dominian cape, rodrigo"] = /obj/item/clothing/accessory/poncho/dominia_cape/kazhkz/white
	dominiacape["dominian cape, marchand"] = /obj/item/clothing/accessory/poncho/dominia_cape/caladius
	dominiacape["white dominian cape, marchand"] = /obj/item/clothing/accessory/poncho/dominia_cape/caladius/white
	dominiacape["dominian cape, stahl-wright"] = /obj/item/clothing/accessory/poncho/dominia_cape/zhao
	dominiacape["white dominian cape, stahl-wright"] = /obj/item/clothing/accessory/poncho/dominia_cape/zhao/white
...
/datum/gear/suit/fisanduhian_bomber
	display_name = "classic cassian bomber jacket selection"
	description = "A selection of Classic Cassian style jackets."
...
/datum/gear/suit/fisanduhian_bomber/New()
	..()
	var/list/coat = list()
	coat["cassian bomber jacket"] = /obj/item/clothing/suit/storage/toggle/dominia/bomber
	coat["long cassian bomber jacket"] = /obj/item/clothing/suit/storage/toggle/dominia/bomber/long
	gear_tweaks += new /datum/gear_tweak/path(coat)
