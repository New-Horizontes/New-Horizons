...
/datum/gear/augment/emotional_manipulator
	...
	description = "A Zeng Hu-designed commercial brain implant to manipulate the brain's chemicals to induce a calming or happy feeling, commonly bought to deal with migraines."
