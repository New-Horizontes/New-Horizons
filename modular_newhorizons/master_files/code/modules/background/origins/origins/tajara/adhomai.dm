...
/singleton/origin_item/origin/northern_rasnrr
	name = "Rasmir Forest"
	desc = "Once a prosperous region known for its hardworking inhabitants, the Rasmir Forest has become one of the bloodiest regions on Azunal. Both the Republic and the Kingdom control various towns within it, and skirmishes between the two are quite frequent. Because of the violence that grips this region, many Tajara have fled the region to seek refuge elsewhere."
...
/singleton/origin_item/origin/harrnrr
	...
	desc = "Far and away two of the largest forests in the entire Spur, the Great Forests of western Vahtul certainly live up to their name. Even in these times, when roads connect cities both big and small, it is no secret that one can easily get lost for good within these woods. The presence of supernatural creatures and locations amongst the trees is widely accepted by the inhabitants of the forest, most of whom carry with them a story or item proving what they saw. The Yasiri Forest to the west is the most developed of the two by the Kingdom's standards, particularly around the bustling port town of Baltor. The Harakh Forest, stretching from Chaniska Lake to the Naljiri Mountains, is much less tame, both in terms of environment and people, as it's often a hotbed for pro-democratic dissidents."
...
/singleton/origin_item/origin/zarrjirah
	...
	desc = "Located in the northwestern portions of Vahtul, the Kasikhaz Mountains have long been one of the most spiritually significant locations in the Kingdom. The area was first discovered by M'sai going through an explosion of interest in the Suns as the time, and the never before seen heights of these mountains instantly turned them into a holy site. As the worship of the Suns spread, a fortress-temple was built within the mountains, known as Sana Sahira. In the present day, the largest settlement is the nearby city of Nizara, who's inhabitants are unsurprisingly known for their spirituality as well as their saintly patience, vital for putting up with the pilgrims from far-off lands."
