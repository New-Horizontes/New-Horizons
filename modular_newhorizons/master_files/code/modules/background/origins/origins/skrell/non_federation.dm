...
/singleton/origin_item/origin/skrell_alliance
	name = "United Nations Interstellar Protectorate" //skrell with dreg accent how
	desc = "With first contact with Humanity, many Skrell elected to move into human space. The Nralakk Federation and the Interstellar Protectorate have been historic allies, and a large majority of Skrell living outside of the Federation calls the Protectorate home."
	important_information = "The Nralakk Federation is known to use its relationship with the Protectorate to step in when Skrell citizens are deemed dangerous to its national security."
...
/singleton/origin_item/origin/skrell_biesel
	...
	desc = "With first contact with Humanity, many Skrell elected to move into human space. The Republic of Biesel has a considerable population of Skrell as it is a Protectorate colony, and the population has only increased with the increase in Corporate sites on the planet. The Republic of Biesel is also a popular destination for those fleeing the Nralakk Federation as there is precedence for the Republic to refuse to deport Federation Skrell if they join the Tau Ceti Foreign Legion."
...
/singleton/origin_item/origin/skrell_coalition
	...
	desc = "With first contact with Humanity, many Skrell elected to move into human space. The Coalition of Independent Systems does not have a large population of Skrell, although it is popular amongst those who wish to avoid Nralakk authorities or otherwise flee the Federation."
