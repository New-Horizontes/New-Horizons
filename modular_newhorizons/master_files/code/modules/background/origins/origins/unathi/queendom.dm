...
//singleton/origin_item/origin/queendom
	name = "Queendom"
	desc = "A wildly different culture compared to most Unathi, the Queendom is a matriarchal society where the normal gender roles are inverted. Born out of the fire of the subjugation war, only time will tell if their new culture will continue onwards, or fall forgotten into the sands of the Wasteland."
