...
/datum/space_sector/srandmarr //FOR THE LOVE OF GOD DON'T USE THIS THERE ARE STILL SO MANY ASSETS THAT ARE STUCK IN OLDLORE
	name = SECTOR_SRANDMARR
	description = "Kra Sana is the star system home to Azunal, the homeworld of the Tajara species. Azunal is the fourth planet from Rensa. It is a cold and icy world, suffering from \
	almost perpetual snowfall and extremely low temperatures. It is currently divided between three factions: the Free Tajara Republic, the Sacred Azunal Kingdom, \
	and the Nozhata Khazsanii."
...
/datum/space_sector/srandmarr/generate_system_name()
	return "Kra Sana, and nearby points of interest"

/datum/space_sector/nrrahrahul //we're just going to pretend this doesn't exist for now
