...
/datum/space_sector/valley_hale
	...
	description = "Nestled in the narrow Frontier space between the Republic of Elyra and the borders of Protectorate space is Valley Hale, a large region filled with a large \
	...
	safer parts of the known Frontier."
...
/datum/space_sector/new_ankara
	...
	native ecosystems already present. Original Protectorate-funded terraforming efforts transformed the planet into an Earthlike planet within a decade, allowing the population to flourish \
...
/datum/space_sector/srandmarr
	...
	almost perpetual snowfall and extremely low temperatures. It is currently divided between several factions involved in a cold war."
...
/datum/space_sector/nrrahrahul
	...
	colony on the planet's surface. The planet is roughly the size of Earth. Most of the planet is dominated by lush jungles except for the poles that possess a subtropical climate; \
...
/datum/space_sector/uueoaesa
	...
	description = "The home of the Unathi race, Bomus is a solar system with 3 rocky planets and 1 gas giant. Alongside the planets of Yzali and Zakkera, Moghes is the homeworld of the Unathi species. \
