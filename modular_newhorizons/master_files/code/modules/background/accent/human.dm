/datum/accent/ceti
	name = ACCENT_CETI
	description = "Often described as the \"true\" way of speaking Tau Ceti Basic, a statement only further reinforced by Nanotrasen, the Biesellite accent is easy to reproduce due to the phonetics of TCB."
	tag_icon = "biesel"
	text_tag = "BSL"

/datum/accent/coc
	name = ACCENT_COC
	description = "The frontier is home to an unknowably vast amount of humans and settlements, covering everything from small outposts of only a few hundred to major planets. \
	It is difficult to define a standard \"Coalition accent,\" or dialect due to the diversity and regionalism of the Coalition, along with its lack of a strong central government. \
...
/datum/accent/eridani
	name = ACCENT_ERIDANI
	description = "The accent of Eridanian \"suits\" is almost universally looked upon as the accent of corporate excellence throughout the Galaxy. \
...
/datum/accent/sol
	name = ACCENT_SOL
	description = "The typical Sol accent, sometimes also called the Protectorate accent or the Human accent, has a hundred tiny variants and can be found on a multitude of planets in countless systems, and is often simply regarded \
	as the \"accent of humanity\" due to its prevalence. It can be found on planets as prominent as Earth or as obscure as settlements on the fringe of Protectorate space."
	tag_icon = "sol"
	text_tag = "SOL"

/datum/accent/scarab
	name = ACCENT_SCARAB
	description = "The common accent of the Migrant Fleet has dozens, perhaps hundreds, of small variations due to the Fleet itself being spread throughout a massive number of \
	individual ships, most of which have their own unique variations upon the standard Migratory accent."
	tag_icon = "scarabs"
	text_tag = "SCA"
...
/datum/accent/luna
	name = ACCENT_LUNA
	description = "The Lunarian accent is regarded throughout the Protectorate, and beyond, as a distinctive mark of being Lunarian. The accent is extremely hard for immigrants to Luna \
...
/datum/accent/gibson_ovan
	...
	description = "The New Gibson Ovanstad accent is very close to the accent of Tau Ceti proper, due to the nature of the planet's colonization. However, Gibsoners are known for talking \
...
/datum/accent/gibson_undir
	...
	description = "The New Gibson Undirstad accent is not wildly known or heard outside of Gibson itself, as those hailing from the Undirstads are quite insular and isolated from the more attractive surface archologies. The Undirstad accent is much slower than the Ovanstad accent, \
...
/datum/accent/konyang
	...
	The Protectorate and The Coalition of Independent Systems. A significant amount of IPCs possess a Konyanger accent, due to the planet being the origin of modern human IPCs and a major producer of them."
	tag_icon = "konyang"
	text_tag = "KNY"
...
/datum/accent/venus
	name = ACCENT_VENUS
	description = "Venusian Common (referred to as Cytherean Common or Maint-Common on Venus itself) is often regarded as one of the most prevalent forms of \
	Hephaestus accents due to the planets vast mining program. On Venus itself this accent is associated with the orbital stations around the planet. \
	Industrial IPCs used throughout human space come pre-programmed with this accent, due to its association with the mining industry."
	tag_icon = "venus"
	text_tag = "VEN"

/datum/accent/venusjin
	name = ACCENT_VENUSJIN
	description = "While Cytherean Common has a reputation abroad as \"Venusian Common\" it is the accent of working-class Jintarian-clad Miners that is, \
	to many on Venus, the true form of Venusian Common. On Venus itself this accent is associated with the working and middle-class \
	population of planetary miners, rather than the station engineers and residents, and many Cythereans look down upon those with this accent as unrefined daredevils. \
	Hendrik Strom, one of Venus' most notable representatives on the UN Assembly, is well-known for having a strong Jintarian accent he makes no attempt to hide."
	tag_icon = "venus_surfacer"
	text_tag = "JIN"

/datum/accent/dominia_high
	name = ACCENT_DOMINIA_HIGH
	description = "The less common Dominian accent is High Cassian, a variation of Tradeband found upon Cassia itself. While Low Cassian is typically associated with the common citizenry of the Empire, \
	High Cassian is associated with the Imperial nobility. While most typically associated with nobles it is often taught to wealthy commoners in order to more easily brush shoulders with nobility. \
...
/datum/accent/dominia_vulgar
	...
	description = "The most common Dominian accent is Low Cassian, sometimes called Vulgar Cassian, a variation of Sol Common found upon Cassia itself. Though heavily influenced by Tradeband, Low Cassian is considered to be a \
	dialect of Sol Common rather than a distinct Tradeband dialect, due to its roots in an amalgamation of old-terran cultures, from the original colonists. Low Cassian has regional variations on the colonies of the Dominian Empire."
	tag_icon = "dominia_vulgar"
	text_tag = "VMR"

/datum/accent/dominia_frontier
	name = ACCENT_DOMINIA_FRONTIER
	description = "Resembling Freespeak more than the Low Cassian dialect found in more civilised regions of the Empire, most accents of the Imperial Frontier are looked down upon by those from the Core Worlds. \
	Many High Nobles and Lowborn look down upon the dialects of the Imperial Frontier as rogue, coarse, and often grating to hear compared to their Common-descended dialects. Many from this region who wish to rise \
	through the ranks of the Empire’s courts spend great amounts of time learning an ersatz Solarian Common dialect based upon this one which is known as the Refined Imperial Frontier Dialect. While not nearly as \
...
/datum/accent/dominia_novijadran
	...
	description = "Much like the planet itself, the Jadranic dialect of Solarian Common sits between standard Solarian Common-influenced Low Cassian and the more Freespeak-derived accents of the Imperial Frontier. \
	The dialect possesses grammar and pronunciation similar to Low Cassian but possesses multiple loan words from Freespeak which make it distinct from its Cassian counterpart. Jadraners are valued highly for their \
	...
	loan words out while talking with Cassians or other Dominians."
	tag_icon = "dominia_novijadran"
	text_tag = "NOV"

/datum/accent/dominia_lyodii
	name = ACCENT_DOMINIA_LYODII
	description = "Most commonly associated with Porters, otherwise known as the People of Starport, Porter Cassian is a variation of the common Low Cassian dialect which is most notable for its sing-song pace of speech \
	which makes it distinctive from standard Low Cassian. Porter Cassian is common to hear in the broader Empire and abroad, due to Starport´s influence as the main trade port in the Imperial \
	Core. Those who hear the dialect \
	spoken, or sung during Porter folk-songs, often state it has an eerie beauty, as the sounds of these songs can carry for long distances across the long hallways of Starport´s hab-stations."
	tag_icon = "dominia_lyodii"
	text_tag = "LYD"

/datum/accent/dominia_sunreach
	name = ACCENT_DOMINIA_SUNREACH
	description = "Regarded by most linguists as a Freespeak dialect, but classified by the Empire as a dialect of Low Cassian, the Sun Reacher dialect is one of the more well-known accents of the Imperial Frontier. \
	Previously associated with the Pirate Lords of Sun Reach and their raids on nearby worlds, the Reacher accent is now commonly heard from the voidsmen and officers of the Imperial Fleet and the Emperor's Flotilla. \
	Reachers who wish to demonstrate their loyalty to the Empire and a desire to assimilate into its culture will often go to great lengths to learn and speak a House MacGregor-design pronunciation system which replaces \
...
/datum/accent/jupiter
	name = ACCENT_JUPITER
	description = "The Jovian accent is an odd mish-mash of accents from Jupiter's various moons, and has heavy variation on each of the moons, and its orbital habitats. On Europa, the Jovian accent often takes on traces of \
	...
	Freespeak Jovian accent, due to the infamous installation on the moon, and none dare to contest it. Some on Castillo vehemently believe that the Callistean accent should be considered the standard for Jovian accents."
	tag_icon = "jupiter"
	text_tag = "JUP"
...
/datum/accent/earth
	name = ACCENT_EARTH
	description = "The typical Earth, or Terran, accent of the modern era has its roots in the dominant languages of Earth, being a mix of all of them, including examples such as Chinese Mandarin, English, French, Spanish and Arabic. All accents found in human space - \
...
/datum/accent/xanu
	name = ACCENT_XANU
	description = "The New Xanu Standard dialect is arguably the most notable Freespeak dialect and is most often found in Union of Progressive Peoples Space. Xanu Standard, also referred to as True Union Standard, first emerged as an informal creole designed to make communication between the various nationalities \
	who settled the planet easier and used loan words from upwards of a half-dozen languages during this early period with heavy influences coming from Chinese Mandarin. Over time this creole would morph into the Xanu Standard dialect of Freespeak \
...
/datum/accent/ncf
	name = ACCENT_NCF
	description = "The non-Coalition frontier 'accent' is not a true accent in of itself, but is instead used as a catch-all term for human accents originating outside of the frontier controlled by the Coalition of Independent Systems. \
...
/datum/accent/fisanduh
	...
	description = "While it is similar to the typical Xanu Standard accent to those not familiar with it, the standard Union accent has some variations that mark it as distinctive. \
	The accent is higher pitched than its New Xanu counterpart, and has been described as more tonal. The Union Standard accent was created when the New Xanu Standard dialect failed to spread beyond its core worlds, and is now often regarded as the Union member accent."
	tag_icon = "fisanduh"
	text_tag = "FIS"
...
/datum/accent/gadpathur
	...
	survivalist history of the planet. Due to the government's tight control over Gadpathur, and push for unity in the face of future disasters, Gadpathurians have \
...
/datum/accent/pluto
	...
	of Hellenic and Eastern European dialects, the Plutonian accent is notable for its slow, methodical method of speech. Very few non-Charon positronics can be found with this accent, due to Pluto's Ownership, and it is considered the average accent for most Charon Shipping employees."
	tag_icon = "pluto"
	text_tag = "PLU"
...
/datum/accent/visegrad
	...
	description = "The Visegradi accent is unique for that of a Solarian world, being a Tradeband accent with strong influences from the various languages of Earth, it is primarily characterized by being described as Sol Common but slower. Decidedly harsh and characterized by unusual \
	and eclectic pronunciation, it can be fairly difficult to parse for those unfamiliar with it especialy due to the rarity of the accent, being only common in Visegradi patients and residents. This is only somewhat stymied by the fact that Visegradi people tend to either speak barely above a whisper, or speak very loudly, an adaptation necessitated by the need to \
	make oneself heard during the planet's torrential downpours or over sudden outbursts."
	tag_icon = "visegrad"
	text_tag = "VIS"
