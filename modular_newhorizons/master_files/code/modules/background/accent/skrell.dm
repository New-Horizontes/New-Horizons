...
/datum/accent/skrell/sol
	...
	the Protectorate. The accent has kept the notable tones from accents found in the Federation, while still heavily influenced by the pacing and pronunciation common in the \
...
/datum/accent/skrell/coc
	...
	description = "Coalition Skrell Standard refers to the various accents of Skrell living within the Free Systems. Heavily influenced by Freespeak, this accent \
	is more guttural, with lower-pitched tones being more prevalent. The Coalition of Independent Systems has a reputation for being generally anti-Government in policy, which has \
