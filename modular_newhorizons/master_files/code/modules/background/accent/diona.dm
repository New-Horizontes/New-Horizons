...
/datum/accent/sandsong
	...
	description = "Found exclusively in Dionae hailing from the Unathi-Dominated worlds in the Bomus system, Sandsong is a distinct variation of Rootsong notable for having its tempo much more drawn out, with tones of higher pitches especially having a much more exaggerated sound. Dionae speaking with the Sandsong accent will typically hold certain speech patterns held by Unathi such as hissing out their S’s and difficulties pronouncing the letter X. "
	tag_icon = "dionae_sandsong"
	text_tag = "SDS"

/datum/accent/wastesong
	name = ACCENT_WASTESONG
	description = "Originating from irradiated Wastes or uninhabitable worlds, Wastesong is an accent spoken by Dionae who found themselves being bathed in radiation, making them healthy and much more resilient than some of their other planet-bound brethren, but also giving them a slightly distinct accent notable for having a lower-pitched voice compared to regular Rootsong but also a much faster tempo. Much like Sandsong, Dionae with the Wasteland accent will typically carry similar speech patterns to Unathi such as hissing out their S’s."
