...
/datum/law/med_severity/abuse_confiscated
	...
	desc = "To take and use equipment confiscated as evidence, without a justifiable reason or proper cause."
	id = "i204"
...
/datum/law/med_severity/assault
	name = "i208 - Assault"
	desc = "To cause severe injury to another employee. To cause reparable damage to the chassis of an IPC."
	id = "i208"
...
/datum/law/med_severity/excessive_force
	...
	desc = "To use excessive violence, such as putting someone in critical state in defense of yourself or others after they attempted to flee or surrender, or seriously injuring a suspect while attempting to detain them, without justifiable reason. This includes pulling them when they have open wounds."
	id = "i218"
...
/datum/law/med_severity/unregistered_ipc
	...
	desc = "To function as an untagged or unregistered positronic machine, or to function as a positronic machine with a tag that has been tampered with or rendered inoperable."
	id = "i222"
...
/datum/law/med_severity/kidnapping_ipc
	name = "i223 - Kidnapping of Artificial Intelligence"
	desc = "To take away or transport a positronic intelligence against its will, or that of its owning entity."
	id = "i223"
