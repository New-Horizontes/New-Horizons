...
/datum/language/terminator
	...
	desc = "A heavily encrypted communication network that piggybacks off of the state telecomms relays to covertly link clandestine black ops droids to their control AIs."
