...
/datum/language/unathi
	...
	short = "MHOS"
	desc = "The common language of Moghes, composed of sibilant hisses and rattles. Spoken natively by most Unathi. Commonly associated with the planet and its conservative noble elite. Aside from new terminology being introduced this language remains relatively unchanged from the time of the ancient God-Kings called Ensi, and as a result it’s difficult to learn."
...
/datum/language/unathi_azaziba
	...
	short = "YALZ"
	desc = "The language of Yzali Unathi, consisting of a combination of spoken word and gesticulation. It is commonly associated with the planets luxuriates, Trade-Princes, and modernity. It evolved from the language families of the Trade League that settled the planet. There are hundreds of dialects across the planet, but all of them are, more or less, mutually intelligible."
	speech_verb = list("hisses")
	ask_verb = list("hisses")
	exclaim_verb = list("roars")
...
/datum/language/human
	...
	short = "SOL"
	desc = "With its roots in the most common Terran languages, including Chinese Mandarin, English, French, Spanish and Arabic, Common evolved as the official language of the Protectorate, with officials working to tie it together with a common tongue. It's spoken by state officials, taught in schools, and spoken by most Protectorate colonies, either as their main language or a secondary one."
	colour = "solcom"
...
/datum/language/machine
	name = LANGUAGE_EAL
	short = "EAL"
	desc = "A language of encoded tones that allow for IPCs and other synthetics to communicate auditorily between each other in a manner that allows for easier transfer of information."
