/datum/species/tajaran
	...
	secondary_langs = list(LANGUAGE_SIIK_MAAS, LANGUAGE_SIGN_TAJARA, LANGUAGE_YA_SSA)
	...
	blurb = "The Tajaran race is a species of feline-like bipeds hailing from the planet of Azunal in the Kre Sana \
	...
	a variety of languages, mostly Yapudi, using unique inflections their mouths form."
