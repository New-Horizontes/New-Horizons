/datum/species/machine/shell
	...
	job restrictions. Created in the late days of 2450 by OSS commission, the Shell is a controversial IPC model equipped with a synthskin weave applied over its metal chassis \
