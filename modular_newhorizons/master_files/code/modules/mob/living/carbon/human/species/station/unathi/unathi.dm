/datum/species/unathi
	...
	blurb = "A heavily reptillian species, Unathi (or 'Sinta as they call themselves) hail from the Bomus \
	system. A relatively recent addition to the galactic stage, they \
	suffered immense turmoil after a massive solar wiped out their nascent empire many years ago.<br><br>\
	While the homeworld of Moghes is ruled by ancient God-Kings, the Ensi, who are locked in a bitter rivalry with the Tech-Princes of Yzali , the \
	Hegemony that unites the majority of the species struggles to find itself in a galaxy filled with dangers far \
