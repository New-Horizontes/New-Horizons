...
/obj/item/device/firing_pin
	...
	desc = "A small authentication device, to be inserted into a firearm receiver to allow operation. UNIP safety regulations require all new designs to incorporate one."
