...
/obj/item/gun/projectile/shotgun/pump/combat/sol
	name = "protectorate combat shotgun"
	desc = "A compact combat shotgun manufactured by Zavodskoi Interstellar for the Protectorate Armed Forces, the M63 is most frequently employed by assaulters fighting in close-quarters environments, though it is also uncommonly used as a defensive weapon by Navy crewmen. Chambered in 12 gauge."
