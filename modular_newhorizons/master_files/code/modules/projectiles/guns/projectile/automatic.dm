...
/obj/item/gun/projectile/automatic/c20r
	...
	desc_extended = "The Colettish Armaments Model 25 SMG is a typical product of the San Colette Interstellar Armaments Company (CAISC). Rejected by the Protectorate army due to competition with the Zavodskoi M470-L, the CA-M25 was repurposed \
	into the Colettish Armaments Model 25 Export (CA-25E) and has found reasonable success in mercenary groups across the Orion Spur, as well as many colonies looking to outfit their System Defence Forces."
...
/obj/item/gun/projectile/automatic/c20r/sol
	name = "protectorate submachine gun"
	desc = "Designed by Zavodskoi as a scaled-down version of their M469, the M470-L is a personal defense weapon intended for use by second-line personnel from all branches of the Protectorate military, such as support troops and Navy crewmen."
...
/obj/item/gun/projectile/automatic/rifle/sol
	name = "protectorate assault rifle"
	desc = "A reliable assault rifle manufactured by Zavodskoi Interstellar, the M469 is the standard service rifle of the Protectorate Armed Forces, most commonly associated with its ground forces. \
	Though the design is old, it continues to see widespread use in the Protectorate and its colonies and likely will for years to come."
...
/obj/item/gun/projectile/automatic/rifle/dom
	...
	desc = "The standard issue rifle of the Empire of Dominia’s Imperial Army. With its sleek lines and ruggedized faux wood furniture, the CPR-24/5 \
	is as elegant as it is deadly, proving itself in service during Dominia's numerous colonial conflicts."
	desc_extended = "The Cassia Pattern Rifle, Year of 2424 has been the standard issue rifle of the Imperial Army for decades thanks to its durable construction and ease of use. \
	The Imperial Army has repeatedly modernized and updated the MPR-24 over the past 40 years, and the rifle is now in its fifth modernization: one that they hope will keep it competitive well into the 2600s."
...
/obj/item/gun/projectile/automatic/rifle/jingya
	...
	desc_extended = "The Jingya A-1 won a hard-fought victory in the ballistic side of the UNIP Future Firearms contest hosted in 2586, which was also its first unveiling: this rifle is made to function where laser weaponry may be either too risky or not functional for the engagement at hand. It is slated to be deployed for trial usage by a select few special TCFL regiments in Mictlan due to Nanotrasen request."
...
/obj/item/gun/projectile/automatic/rifle/l6_saw
	...
	The CA-75E is not used by San Colette’s Civil Guard and is typically sold to mercenary groups or other Protectorate systems."
...
/obj/item/gun/projectile/automatic/tommygun/dom
	...
	desc_extended = "The Cassia Pattern Machine Carbine, Model of 2430 is a lightweight, handy weapon intended for use by vehicle crews, airborne troops, and other units that do not require a full-length rifle. \
	Simplistic in design and function, the CPMC-30 is highly reliable in nearly all environments, lending itself well to use by colonial forces. In particular, the Imperial Novoyakutsk Gendarmerie are known to make heavy use of the weapon."
