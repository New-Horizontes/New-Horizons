...
/obj/item/gun/projectile/revolver/mateba/captain
	name = "\improper UNIP command autorevolver"
	desc = "A ludicrously powerful .454 autorevolver with equally ludicrous recoil which is issued by the UNIP to the administrators of critical facilities and vessels. While revolvers may be considered a thing of the past, the stopping power displayed by this weapon is second to none."
	...
	desc_extended = "A Zavodskoi Interstellar design from the mid 2650s intended for export to the Eridani Corporate Federation and the Republic of Biesel, the Protektor \
