/obj/item/gun/projectile/colt
	...
	desc_extended = "The Pattern 5 Pistol is the standard-issue sidearm for the Civil Guard, San Colette’s local military force. Loosely based on the standard 9mm pistol of the Protectorate Army, the P5 fires a larger .45 round intended for use against heavier targets. \
...
/obj/item/gun/projectile/silenced
	...
	desc_extended = "Created as a disposable and concealable weapon, the Mrrazhakulii suppressed pistol is a firearm with a suppressor integrated as part of its barrel. \
		...
		recycled iron and tires, countless of those pistols were distributed among cells and insurrectionist soldiers."
...
/obj/item/gun/projectile/pistol/sol
	name = "protectorate service pistol"
	desc = "Manufactured by Zavodskoi Interstellar and based off of a full-sized variant of their 9mm design, the compact M8 is the standard service pistol of the Protectorate Armed Forces."
