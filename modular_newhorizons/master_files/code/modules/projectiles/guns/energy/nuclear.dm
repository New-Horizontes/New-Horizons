...
/obj/item/gun/energy/pistol/hegemony
	...
	desc_extended = "This is the Zkrehk-Guild Beamgun, an energy-based sidearm designed and manufactured on Yzali. A special crystal used in its design allows it to penetrate armor with pinpoint accuracy."
...
/obj/item/gun/energy/repeater
	...
	desc = "A United Nations Interstellar Protectorate created energy repeater, extremely lightweight. It has three settings: Single, Three-Burst, and Full-Auto."
	desc_extended = "The UNIP-ER1 was designed to be a reliable yet concealable firearm, capable of defending UNSC assets and agents from various attackers."
