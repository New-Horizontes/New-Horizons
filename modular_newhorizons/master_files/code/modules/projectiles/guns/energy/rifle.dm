...
/obj/item/gun/energy/rifle/laser/noctiluca
	...
	desc_extended = "The Noctiluca XM/24 was unveiled at the tail end of 2586 in the UNIP Future Firearms contest and was released by Zavodskoi in June 2588 after achieving a stunning victory over the other competitors. Zavodskoi installations are prioritized for acquisition of this new rifle, with along the UNIPS Horizon. The Noctiluca's specialty lies in its revolutionary dual-function laser diffuser, which is able to modulate the laser into either a standard beam or an armor-piercing super-concentrated beam."
...
/obj/item/gun/energy/rifle/hegemony
	...
	desc_extended = "The Zkrehk-Guild Heavy Beamgun, an energy-based rifle designed and manufactured on Yzali. A special crystal used in its design allows it to penetrate armor with pinpoint accuracy."
