/obj/item/gun/energy/lawgiver
	...
	sel_mode = 1
	var/mode_check = 1
	desc = "A highly advanced firearm that is capable of several different and highly lethal firing modes, the OSS's ACP-2 is a weapon to be feared."
	...
	var/default_desc = "A highly advanced firearm that is capable of several different and highly lethal firing modes, the OSS's ACP-2 is a weapon to be feared."
