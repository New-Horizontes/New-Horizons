/datum/bounty/item/science/nightvision_goggles
	...
	description = "An electrical storm has busted all the lights at a %BOSSSHORT facility. While the administration is working on replacements, perhaps some night vision goggles can be shipped for emergency services?"
	reward_low = 5200
	reward_high = 6000
