/datum/bounty/item/security/headset
	...
	description = "The %COMPNAME wants to ensure that their encryptions are working correctly. Ship them a security headset so that they can check."
	reward_low = 700
	reward_high = 1200
	random_count = 1
...
/datum/bounty/item/security/securitybelt
	name = "Security Belt"
	description = "A %BOSSNAME facility is having difficulties with their security belts. Ship one from the station to receive compensation."
	reward_low = 700
	reward_high = 1200
	random_count = 1
...
/datum/bounty/item/security/sechuds
	...
	description = "A %BOSSNAME facility is in need of additional security glasses for staffing purposes. They request the station ship some of theirs."
	reward_low = 700
	reward_high = 1200
...
/datum/bounty/item/security/voidsuit
	...
	description = "The %DOCKSHORT crew has misplaced one of their security voidsuits, and a training exercise is about to begin. Ship a spare for a station bonus. Don't forget the helmet."
	reward_low = 2500
	reward_high = 4500
...
/datum/bounty/item/security/maglight
	name = "Maglights"
	description = "Some peacekeeper agents lost their flashlights, and think the plastic ones are too lame. Send some maglights to appease their picky tastes."
	reward_low = 2200
	reward_high = 3000
	required_count = 2
	random_count = 1
...
/datum/bounty/item/security/handcuffs
	name = "Handcuffs"
	description = "A large influx of criminals have arrived at a %BOSSNAME facility for processing and transfer. Now is the perfect time to ship out spare handcuffs."
	reward_low = 1200
	reward_high = 1900
	required_count = 4
	random_count = 2
...
/datum/bounty/item/security/teargas
	...
	description = "We're training some new peacekeeper officers, but our order for tear gas is running behind. Ship some for a bonus to your station's account."
	reward_low = 2000
	reward_high = 3000
	required_count = 3
	random_count = 1
...
/datum/bounty/item/security/smoke
	name = "Smoke Grenades"
	description = "We need a few extra smoke grenades to restock our ERTs. Any station that ships spares will be compensated."
	reward_low = 2200
	reward_high = 3200
	required_count = 3
	random_count = 1
...
/datum/bounty/item/security/pepper
	name = "Pepper Spray"
	description = "Time to help some Peacekeeper troopers toughen their response to being pepper sprayed. Any station that helps will be compensated. I love this job. -%PERSONNAME"
	reward_low = 1200
	reward_high = 2200
	required_count = 4
	random_count = 1
