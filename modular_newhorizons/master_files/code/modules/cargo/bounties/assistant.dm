/datum/bounty/item/assistant/briefcase
	name = "Briefcase"
	description = "The %COMPNAME will be holding a business convention this year. Ship a few briefcases in support."
	reward_low = 2000
	reward_high = 3000
	required_count = 4
	random_count = 1
...
/datum/bounty/item/assistant/lung
	name = "Lungs"
	description = "A recent explosion at a %BOSSNAME ship has left multiple staff with punctured lungs. Ship spare lungs to be rewarded- and save some lives."
	reward_low = 2500
	reward_high = 3500
...
/datum/bounty/item/assistant/hand_tele
	name = "Hand Tele"
	description = "A %BOSSNAME station has come up with a genius idea: Why not teleport cargo rather than ship it? Send over a hand tele, receive payment, then wait 6-8 years while they deliberate."
	reward_low = 3000
	reward_high = 5500
...
/datum/bounty/item/assistant/monkey_cubes
	name = "Monkey Cubes"
	description = "Due to a recent genetics accident, a %BOSSNAME facility is in serious need of monkeys. Your mission is to ship monkey cubes."
	reward_low = 1800
	reward_high = 2400
	required_count = 4
	random_count = 1
...
/datum/bounty/item/assistant/film
	name = "Camera Film"
	description = "We received a gift from a delegate on Azunal- a group of some sort of small, fat xenofauna. Everyone thinks they're cute and we're low on film from all the pictures!"
	reward_low = 1200
	reward_high = 1800
	required_count = 3
	random_count = 1
...
/datum/bounty/item/assistant/monkey_hide
	name = "Monkey Hide"
	description = "One of the scientists at a %BOSSSHORT facility is interested in testing products on monkey skin. Your mission is to acquire monkey's hide and ship it."
	reward_low = 1500
	reward_high = 2500
	required_count = 5
	random_count = 1
...
/datum/bounty/item/assistant/statue
	name = "Statue"
	description = "%BOSSNAME Diplomatic administration would like to commision an artsy statue for an embassy lobby. Ship one out, when possible."
	reward_low = 2200
	reward_high = 2800
...
/datum/bounty/item/assistant/cleaner
	name = "Space Cleaner"
	description = "The biohazard janitorial division of our ERT detachment is requesting some actual supplies, to insist they aren't a joke. They're putting up for a bounty, so humor them if you want."
	reward_low = 1000
	reward_high = 1500
	required_count = 3
	random_count = 1
...
/datum/bounty/item/assistant/photograph
	name = "Photographs"
	description = "The %DOCKNAME is holding a morale project, and part of that is to display photographs from the various stations and ships assigned to it. Send us some for a participation bonus!"
	reward_low = 1500
	reward_high = 2500
	required_count = 8
	random_count = 2
