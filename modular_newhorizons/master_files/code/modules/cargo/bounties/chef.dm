...
/datum/bounty/item/chef/soup
	name = "Soup"
	description = "The %COMPNAME will be serving soup to the homeless for a PR initiative. Ship any type of soup. And make sure it's soup- not just hot water."
	reward_low = 2700
	reward_high = 3500
	required_count = 3
	random_count = 1
...
/datum/bounty/item/chef/pie
	name = "Pie"
	description = "Delivery management wants a pie! Ship one pie."
	reward = 3142
...
/datum/bounty/item/chef/salad
	name = "Salad"
	description = "Station management is going on a health binge. Ship some tasty salads to help keep them on track."
	reward_low = 2800
	reward_high = 3800
	required_count = 3
	random_count = 1
...
/datum/bounty/item/chef/poppypretzel
	name = "Poppy Pretzel"
	description = "A %BOSSNAME facility needs a few poppy pretzels for the drug-training of their security department."
	reward_low = 2600
	reward_high = 3200
	required_count = 3
	random_count = 1
...
/datum/bounty/item/chef/cubancarp
	name = "Cuban Carp"
	description = "A diplomat is visiting a %BOSSSHORT facility. Ship one cuban carp for the business luncheon."
	reward_low = 8200
	reward_high = 9200
...
/datum/bounty/item/chef/hotdog
	name = "Hot Dog"
	description = "The %COMPNAME is conducting taste tests to determine the best hot dog recipe. Dont ask. Ship your station's version to participate."
	reward_low = 4000
	reward_high = 4800
...
/datum/bounty/item/chef/eggplantparm
	...
	description = "A famous singer will be arriving at a %BOSSSHORT public event, and their contract demands that they only be served Eggplant Parmigiana. Ship some, please!"
	reward_low = 4000
	reward_high = 4800
	required_count = 3
...
/datum/bounty/item/chef/muffin
	name = "Muffins"
	description = "A %BOSSSHORT office needs muffins for a morning meeting! Your station will get a bonus if you ship some."
	reward_low = 3500
	reward_high = 4200
	required_count = 8
	random_count = 3
...
/datum/bounty/item/chef/kebab
	name = "Kebabs"
	description = "A %BOSSNAME station is requesting a special order; please ship some kebabs."
	reward_low = 3500
	reward_high = 4200
	required_count = 3
	random_count = 1
...
/datum/bounty/item/chef/tajara
	name = "Azunal Delicacies"
	description = "We're holding a luncheon with some representatives from Azunal; send some traditional Tajaran dishes!"
	reward_low = 3500
	reward_high = 5500
	required_count = 3
	random_count = 1
...
/datum/bounty/item/chef/reuben
	...
	description = "%PERSONNAME had their lunch stolen from the office fridge. Send us a replacement reuben!"
	reward_low = 3700
	reward_high = 4600
