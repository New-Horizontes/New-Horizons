/datum/bounty/item/engineer/comfy_chair
	name = "Padded Chairs"
	description = "%PERSONNAME is unhappy with their chair. They claim it hurts their back. Have engineers craft some alternatives and ship them out to humor them, and so they stop annoying us."
	reward_low = 2400
	reward_high = 3900
	required_count = 4
	random_count = 2
...
/datum/bounty/item/engineer/smes_coil
	...
	description = "A xenobotanist from the UNIRS Upsilon sent us a gigantic lemon. We're turning it into a battery; send us an SMES coil so we can contain its power."
	reward_low = 4000
	reward_high = 4500
...
/datum/bounty/item/engineer/crossbow
	...
	description = "Colonial System Defence Forces require weaponry to fulfill their logistics needs and maintain the safety of their local sector, please ship us some powered crossbows."
	reward_low = 5000
	reward_high = 7500
	required_count = 2
