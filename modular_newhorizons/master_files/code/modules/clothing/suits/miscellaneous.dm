...
/obj/item/clothing/suit/storage/toggle/brown_jacket/scc
	name = "United Nations Interstellar Protectorate jacket"
	desc = "A comfortable blue jacket. Tailored upon its back is a large United Nations Interstellar Protectorate logo."
...
/obj/item/clothing/suit/storage/toggle/fib
	name = "\improper DJDA agent jacket"
	desc = "A jacket used by the UNIP’s Department of Justice and Diplomatic Affairs agents while on the field."
