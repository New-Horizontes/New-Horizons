...
/obj/item/clothing/mask/offworlder
	name = "Scavenger scarf"
	desc = "Usually a treasured item, these spider-silk scarves are seen passed down by generations of Scavengers."
	desc_extended = "Scarves like these are passed down from family members in the Migrant Fleet as a coming of age ritual, typically given to children to mark them as worthy of setting off on their own."
