...
/obj/item/clothing/under/rank/operations_manager
	...
	desc = "A uniform worn by the operations manager. It has the UNIP insignia on it."
...
/obj/item/clothing/under/rank/bridge_crew/alt
	...
	desc = "The uniform worn by the UNIP's bridge crew, featuring a skirt."
...
/obj/item/clothing/under/rank/bridge_crew/sancolette
	...
	desc = "A bridge staff uniform in UNIP colors but Colettish style, consisting of trousers and meant to be paired with a jacket. Fancy!"
	desc_extended = "This uniform is based upon an officer's uniform of the Civil Guard of San Colette. The blue-and-white \
	uniforms of the Civil Guard are one of the more striking uniforms found in the system defence forces of the Protectorate, and are often copied by both corporate and civil actors."
	icon_state = "bridge_crew_sancol"
	item_state = "bridge_crew_sancol"

/obj/item/clothing/under/rank/bridge_crew/sancolette/alt
	name = "bridge crew's uniform"
	desc = "A bridge staff uniform in UNIP colors but Colettish style, consisting of navy trousers and meant to be paired with a jacket. Fancy!"
	desc_extended = "This uniform is based upon an officer's uniform of the Civil Guard of San Colette. The blue-and-white \
	uniforms of the Civil Guard are one of the more striking uniforms found in the the system defence forces of the Protectorate, and are often copied by both corporate and civil actors."
...
/obj/item/clothing/under/rank/xo
	...
	desc = "The uniform worn by the UNIP's executive officers."
	icon = 'icons/obj/item/clothing/department_uniforms/command.dmi'
