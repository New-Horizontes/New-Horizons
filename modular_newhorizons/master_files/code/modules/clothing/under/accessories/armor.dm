...
/obj/item/clothing/accessory/leg_guard/military
	name = "protectorate armed forces leg guards"
...
/obj/item/clothing/accessory/arm_guard/military
	name = "protectorate armed forces arm guards"
