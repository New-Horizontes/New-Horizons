...
/obj/item/clothing/accessory/armband/pmc
	name = "\improper OSS armband"
	desc = "An armband, worn by contractors to denote which company they're from. This one bears the logo of the Office of Special Services."
...
/obj/item/clothing/accessory/armband/scc
	name = "UN Interstellar Protectorate armband"
	desc = "An armband, tailored with all the colors of the United Nations Interstellar Protectorate."
