/obj/item/clothing/accessory/sinta_hood
	name = "commoner hood"
	desc = "A hood worn commonly by unathi commoners away from home."
...
/obj/item/clothing/accessory/unathi
	name = "Zakkeran belt"
	desc = "A simple belt fashioned from cloth, the gyazo belt is an adornment that can be paired with practically any Unathi outfit and is a staple for any Sinta.\
	Fashionable and comes in a variety of colors"
	icon = 'icons/obj/unathi_items.dmi'
	icon_state = "sash"
	item_state = "sash"
	contained_sprite = TRUE
...
/obj/item/clothing/accessory/poncho/maxtlatl
	name = "Enshi-Style Attire"
	desc = "A traditional garment worn by Ensi-Worshippers of high status.\
	Popular adornments include dried and pressed grass and flowers, in addition to colorful stones placed into and hanging off of the mantle."
...
/obj/item/clothing/accessory/poncho/unathimantle
	...
	trophy among desert Zakkerans: someone's been hunting!"
...
/obj/item/clothing/accessory/poncho/unathimantle/forest
	...
	desc = "The cured hide and skin of a large beast, tapered off with a colorful collar, commonly seen for Zakkeran Unathi, from the forest regions of their planet."
...
/obj/item/clothing/accessory/poncho/unathimantle/hephaestus
	...
	desc_extended = "Hephaestus alone of all the megacorporations has integrated itself into the Hegemony guild system of the Unathi people - they employ thousands of Sinta seeking \
...
/obj/item/clothing/accessory/poncho/unathimantle/bard
	...
	to this ancient and illustrious guild. Outside of the Hegemony, they are mainly known for their operation of the largest news outlet of the Hegemony."
...
/obj/item/clothing/accessory/poncho/unathimantle/med
	...
	their position in the guild."
	desc_extended = "The House of Medicine oversees the Skalamar University of Medicine, one of the oldest educational institutions in the Bomus system. To be a guildsman of the House is equivalent \
...
/obj/item/clothing/accessory/poncho/unathimantle/construction
	...
	their position in the guild."
	desc_extended = "The Construction Coalition is a unique guild, operating far more democratically than others. It originated as a loose federation of local construction guilds, before being approved as a Hegemony guild\
	Many of the castles of the nobility and the great cities of Moghes were constructed and are still maintained by \
...
/obj/item/clothing/accessory/poncho/unathimantle/union
	...
	their position in the guild."
	desc_extended = "A new movement in Unathi space, but one with a foothold of influence in the southern regions of Yzali, the Hearts of Industry resemble a workers' union more than a traditional guild. \
	Their membership has grown in the factories and docks of Jaz'zirt, and they have often clashed with the Moghan nobility and the Northern Yzali Tech-Princes on matters of workers' rights. While membership in the Hearts \
	is not illegal, the organisation's growing power threatens the status quo, and their meetings have often been brutally struck down by an Ensi when done anywhere on Moghes."
...
/obj/item/clothing/accessory/poncho/unathimantle/fighter
	...
	their position in the guild."
	desc_extended = "The Fighters' Lodge was created in the years following first contact, some would say it was inspired by human private military contractors, but to say so would be an insult to Unathi warrior culture. As such, it has an unusual structure for an Unathi guild, \
	resembling an army more than the traditional guilds of Moghes. The Fighters' Lodge mainly takes jobs as security for merchants, with their charter preventing them from \
	taking sides in the power struggles of the powers of Bomus."
