...
/obj/item/clothing/accessory/poncho/roles/cloak/security
	...
	desc = "A simple dark blue cloak awarded by the UN for failing the introductory literacy test."
	icon_state = "seccloak"
	item_state = "seccloak"
...
/obj/item/clothing/accessory/sol_pin
	name = "Protectorate pin"
	desc = "A small pin of the United Nations Interstellar Protectorate, shaped like a golden sun."
	icon_state = "sol-pin"
	item_state = "sol-pin"
...
/obj/item/clothing/accessory/sleevepatch/scc
	name = "United Nations Interstellar Protectorate patch"
	desc = "An embroidered patch, adorned with the logo of the Protectorate, which can be attached to the shoulder sleeve of clothing."
	desc_extended = "The United Nations Interstellar Protectorate, also known as The Protectorate or simply EarthGov, is the main ruling government of humanity, and the direct successor of the United Nations."
...
/obj/item/clothing/accessory/sleevepatch/erisec
	name = "\improper OSS-C sleeve patch"
	desc = "A digital patch which can be attached to the shoulder sleeve of clothing. This one denotes the wearer as a Contractor employed by the Office of Special Services."
...
/obj/item/clothing/accessory/pin/corporate/pmc
	desc = "A shiny button which reads, <i>'Office of Special Services - The first line. The last resort.'</i>"
...
/obj/item/clothing/accessory/pin/corporate/orion
	desc = "A shiny button which reads, <i>'Charon Shipping - Anytime, anywhere!'</i>"
