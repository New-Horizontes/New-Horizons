...
/obj/item/clothing/under/rank/centcom_captain
	name = "officer's dress uniform"
	desc = "Gold trim on space-black cloth, this uniform displays the rank of \"Sector Admiral.\""
	icon_state = "centcom"
	item_state = "bl_suit"
	worn_state = "centcom"
	displays_id = 0
...
/obj/item/clothing/under/rank/scc
	name = "United Nations Interstellar Protectorate agent uniform"
	desc = "A formal blue uniform worn by agents of the United Nations Interstellar Protectorate."
...
/obj/item/clothing/under/rank/scc/executive
	name = "United Nations Interstellar Protectorate administrator uniform"
	desc = "A stylish purple uniform worn by high ranking agents of the United Nations Interstellar Protectorate."
...
/obj/item/clothing/under/rank/centcom_commander
	desc = "Gold trim on space-black cloth, this uniform displays the rank of \"Commander.\ It has a patch denoting a Phoenix on the sleeves."
