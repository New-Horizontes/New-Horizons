...
/obj/item/clothing/wrists/unathi/maxtlatl
	name = "Ensi-Style wristguards"
	desc = "A traditional garment worn by Ensi worshippers of high status. Popular adornments include dried and pressed grass and feathers, as well as precious metals and colorful stones in the cuff itself."
