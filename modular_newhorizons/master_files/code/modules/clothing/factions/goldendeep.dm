/obj/item/clothing/under/goldendeep
	...
	desc_extended = "The Lux-I Golden Dress was popularised 8 years ago by Lux-Igmatic, one of the first official Golden Deep positronic employees. Owing to its success outside of the GD fashion scene, it quickly caught on \
...
/obj/item/clothing/under/goldendeep/vest
	...
	desc_extended = "With the increasing popularity of gold-effect clothing within Golden Deep culture, it was only a matter of time before casual clothing lines got in on the action. Following the leak of Lux-Igmatic's methods, other corporations jumped at the \
	...
	may still be far out of the reach of the masses, but it barely approaches a fraction of the cost of a golden two piece, and is certainly far, far cheaper than the dresses made by Lux-Igmatic."
...
/obj/item/clothing/under/goldendeep/suit
	...
	It wasn't until 2458, however, that the golden suits were seen in greater numbers among Golden Deep employees. Until then, it had been trendy to stick with flowing, breathable clothing options among other employees. \
	Trading with external societies has become more competitive, and as such old rivalries among GD members and traders have been rekindled - necessitating the need to 'keep up appearances' even within exclusively \
...
/obj/item/clothing/under/goldendeep/skirtsuit
	...
	were seen in greater numbers among Golden Deep merchants. Until then, it had been trendy to stick with flowing, breathable clothing options among other employees. Trading with external societies has become more competitive, and as such old rivalries among \
	GD members and traders have been rekindled - necessitating the need to 'keep up appearances' even within exclusively Golden Deep social circles."
