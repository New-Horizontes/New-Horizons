...
/obj/item/clothing/head/wool/pmc
	name = "oss woolen hat"
	desc = "A warm woolen hat in OSS colors. Because spies get cold too!"
	icon_state = "hat_pmc"
	item_state = "hat_pmc"
...
/obj/item/clothing/head/wool/heph
	...
	desc = "A warm woolen hat in Hephaetus Indrustries colors. Industrial strength head heating!"
	icon_state = "hat_heph"
	item_state = "hat_heph"
...
/obj/item/clothing/head/wool/orion
	name = "charon woolen hat"
	desc = "A warm woolen hat in Charon Shipping colors. Cozy employees deliver cargo faster!"
...
/obj/item/clothing/head/wool/scc
	name = "unip woolen hat"
	desc = "A warm woolen hat in UNIP colors. Is that real gold in the wool?"
	icon_state = "hat_scc"
	item_state = "hat_scc"
