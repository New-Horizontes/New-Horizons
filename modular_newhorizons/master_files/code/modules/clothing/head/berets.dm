...
/obj/item/clothing/head/beret/corporate/pmc
	name = "OSS beret"
	desc = "A beret with the Office of Special Services insignia emblazoned on it."
	icon_state = "pmc"
	item_state = "pmc"
...
/obj/item/clothing/head/beret/corporate/orion
	name = "charon shipping beret"
	desc = "A beret with the Charon Shipping Services insignia emblazoned on it."
	icon_state = "orion"
	item_state = "orion"
...
/obj/item/clothing/head/beret/centcom/officer
	name = "officers beret"
	desc = "A black beret adorned with the shield - a silver kite shield with an engraved sword - of the United Nations Interstellar Protectorate."
...
/obj/item/clothing/head/beret/centcom/civilprotection
	...
	desc = "A black beret adorned with the shield - a gold kite shield with an engraved sword - of the United Nations Interstellar Protectorate."
...
/obj/item/clothing/head/beret/centcom/commander
	...
	desc = "A black beret adorned with the crest of an ERT detachment. Worn by commanders of Protectorate response team taskforces."
	icon_state = "centcomcaptain"
	item_state = "centcomcaptain"
