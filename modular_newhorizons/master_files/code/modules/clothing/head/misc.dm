...
/obj/item/clothing/head/leader_headband
	...
	desc = "A simple headband that is used to denote the leader of a Protectorate militia team."
...
/obj/item/clothing/head/sol
	name = "protectorate navy utility cover"
	desc = "A military cover issued to UNIP Navy personnel as part of their utility uniform."
...
/obj/item/clothing/head/sol/dress
	name = "protectorate navy black peaked cap"
	desc = "A black cap issued as part of the UNIP naval officer uniforms. This one is worn by junior officers."
	icon_state = "navy_cap_officer"
	item_state = "navy_cap_officer"

/obj/item/clothing/head/sol/dress/officer
	name = "protectorate navy officer peaked cap"
	desc = "A white cap issued as part of the UNIP naval officer uniforms. This one is worn by senior officers."
	icon_state = "navy_cap_senioroff"
	item_state = "navy_cap_senioroff"

/obj/item/clothing/head/sol/dress/admiral
	name = "protectorate navy admiral peaked cap"
	desc = "A white cap issued as part of the UNIP naval officer uniforms. This one is worn by admirals."
...
/obj/item/clothing/head/sol/marine
	...
	desc = "An eight pointed cover issued to 'Solarian marines' as part of their field uniform. A vital part of the full costume."
	icon_state = "marine_utility"
	item_state = "marine_utility"

/obj/item/clothing/head/sol/marine/grey
	name = "'marine' utility cover"
	desc = "An eight pointed cover issued to 'Solarian' marines as part of their field uniform. A vital part of the full costume, in grey!"
	icon_state = "marine_utility_grey"
	item_state = "marine_utility_grey"

/obj/item/clothing/head/sol/garrison
	name = "'marine' garrison cap"
	desc = "A green garrison cap issued to 'Solarian marines'. A vital alternative to go with the full costume."
	icon_state = "greengarrisoncap"
	item_state = "greengarrisoncap"

/obj/item/clothing/head/sol/dress/marine
	name = "'marine' peaked cap"
	desc = "A green cap issued as part of the 'Solarian marine' service and dress uniforms. This particular design is based off of a popular movie."
...
/obj/item/clothing/head/helmet/sol
	name = "Protectorate combat helmet"
...
/obj/item/clothing/head/sol/army
	name = "protectorate army field cap"
	desc = "A cloth field issued to Protectorate soldiers as part of their field uniform."
	icon_state = "army_field"
	item_state = "army_field"

/obj/item/clothing/head/sol/army/grey
	name = "protectorate field cap"
	desc = "A cloth field issued to Protectorate soldiers as part of their field uniform."
	icon_state = "army_field_grey"
	item_state = "army_field_grey"

/obj/item/clothing/head/sol/army/service
	name = "protectorate peaked cap"
	desc = "A green peaked cap issued as part of Protectorate Army service uniforms. A small silver pin of the UNIP seal is attached to the peak. A enlisted-person or NCO should wear this."
	icon_state = "army_cap"
	item_state = "army_cap"

/obj/item/clothing/head/sol/army/service/officer
	name = "protectorate army officer peaked cap"
	desc = "A green peaked cap issued as part of Protectorate Army service uniforms. A large gold pin of the UNIP seal is attached to the peak. Commonly worn by lower ranking officers."
	icon_state = "army_cap_officer"
	item_state = "army_cap_officer"

/obj/item/clothing/head/sol/army/service/senioroff
	name = "protectorate army senior officer peaked cap"
	desc = "A green peaked cap issued as part of Protectorate Army service uniforms. A large gold pin of the UNIP seal is attached to the peak and leaf-shaped embellishments rap around the visor. Issued to senior officers."
	icon_state = "army_cap_senioroff"
	item_state = "army_cap_senioroff"

/obj/item/clothing/head/sol/army/service/general
	name = "protectorate army general peaked cap"
	desc = "A green peaked cap issued as part of Protectorate Army service uniforms. A large gold pin of the UNIP seal is attached to the peak and leaf-shaped embellishments rap around the visor. Reserved for high ranking officers."
	icon_state = "army_cap_general"
	item_state = "army_cap_general"

/obj/item/clothing/head/sol/army/service/garrison
	name = "protectorate army garrison cap"
	desc = "A green garrison cap issued as part of Protectorate Army service uniforms, for when a peaked cap is impractical or unnecessary. All enlisted-people and NCOs should wear this."
	icon_state = "army_garrison"
	item_state = "army_garrison"

/obj/item/clothing/head/sol/army/service/garrison/officer
	name = "protectorate army garrison cap"
	desc = "A green garrison cap issued as part of Protectorate Army service uniforms, for when a peaked cap is impractical or unnecessary. A golden rank pin is attached to one side. All officers can wear this."
	icon_state = "army_garrison_officer"
	item_state = "army_garrison_officer"

/obj/item/clothing/head/sol/army/service/campaign
	name = "protectorate army campaign hat"
	desc = "A green campaign hat issued as part of Protectorate Army service uniforms. The NCOs that scream at you more than the normal ones should wear this."
