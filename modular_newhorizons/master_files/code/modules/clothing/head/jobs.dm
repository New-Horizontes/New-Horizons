...
/obj/item/clothing/head/caphat/xo
	...
	desc = "A stylish cap issued to UNIP executive officers."
...
/obj/item/clothing/head/caphat/bridge_crew
	...
	desc = "A stylish cap issued to the bridge crew of UNIP vessels."
	icon = 'icons/obj/item/clothing/department_uniforms/command.dmi'
	contained_sprite = TRUE
...
/obj/item/clothing/head/caphat/bridge_crew/alt
	name = "bridge crew cap"
	desc = "A more formal hat in a Colettish style, authorized for the bridge crew of UNIP vessels."
	desc_extended = "Designed to allow the wearer to wear both a peaked cap and a radio headset, Colettish 'crusher' caps are prized throughout Protectorate space for their comfort."
...
/obj/item/clothing/head/sidecap/pmcg
	name = "oss garrison cap"
	desc = "A simple cap, often worn by pilots. This one is in OSS colors."
