...
/obj/item/clothing/head/unathi/maxtlatl
	name = "Ensi-Style Helm"
	desc = "A traditional garment worn by Ensi worshippers of high status to flaunt their wealth and status by the blessing of their Ensi. Colorful feathers surround a porcelain skull."
