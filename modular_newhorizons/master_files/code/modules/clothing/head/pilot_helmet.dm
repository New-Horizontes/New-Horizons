...
/obj/item/clothing/head/helmet/pilot/scc
	name = "Protectorate flight helmet"
	desc = "A pilot helmet with the deep colors of the United Nations Interstellar Protectorate. The highlight is a navy blue, and the mounted visor a striking, opaque cyan. The visor feeds its wearer in-flight information via an integrated heads-up display."
