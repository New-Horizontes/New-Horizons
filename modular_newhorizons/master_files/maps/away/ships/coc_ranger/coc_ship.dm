/datum/map_template/ruin/away_site/ranger_corvette
	name = "Ranger Gunboat"
	description = "The Xansan-class is not, in fact, a distinct design in of itself. It is instead Xanu Prime’s variant of the Lagos-class gunboat, an old UNICE light attack ship design. While the Lagos-class has been out of service with the Protectorate’s navy for centuries, the blueprints were leftovers during the Interstellar Exploration period provided to the New Xanu colonists for post-colonization production, and were eventually used to construct ships of the class for use by the UPC’s newfound military. While the Xansan-class has been slowly retired from UPP service, many of these ships were donated en masse to the Free Systems and the Frontier Marshal Bureau, and the Rangers make use of the craft to this day, in spite of their advanced age."
...
/obj/effect/overmap/visitable/ship/ranger_corvette
	...
	designer = "Union of Progressive Peoples, New Xanu"
