...
/obj/effect/overmap/visitable/ship/landable/air_konyang
	...
	desc = "The Peregrine-class civilian transport, manufactured by Einstein Engines, is a frequent favorite for interstellar travel. The design is most commonly seen owned by Protectorate spacelines, as well as the Konyang-based Air Konyang."
	icon_state = "generic"
