/datum/ghostspawner/human/ee_crewman
	...
	desc = "Crew the Einstein Engines research (or more accurately, spy) ship. Collect intelligence on the UNPV Horizon, all while maintaining plausible deniability. NOTE: While you may be antagonistic by design and intent, upfront confrontations are discouraged, and intrigue or stealth is advised to ensure your survival."
	tags = list("External")
...
/datum/ghostspawner/human/ee_research_officer
	...
	desc = "Command the Einstein Engines research (or more accurately, spy) ship. Collect intelligence on the UNPV Horizon, all while maintaining plausible deniability. NOTE: While you may be antagonistic by design and intent, upfront confrontations are discouraged, and intrigue or stealth is advised to ensure your survival."
	tags = list("External")
