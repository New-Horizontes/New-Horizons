...
/datum/ghostspawner/human/ranger
	...
	desc = "Crew the Ranger gunboat. Protect the interests of the Coalition of Independent Systems and your member-state."
	tags = list("External")
...
/datum/ghostspawner/human/ranger/captain
	...
	desc = "Lead the Ranger gunboat. Protect the interests of the Coalition of Independent Systems and your member-state."
