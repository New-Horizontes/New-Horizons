/datum/map_template/ruin/away_site/coc_surveyor
	name = "UPP Survey Ship"
	description = "Union science ship."
...
/singleton/submap_archetype/coc_surveyor
	map = "UPP Survey Ship"
	descriptor = "Union science ship."

/obj/effect/overmap/visitable/ship/coc_surveyor
	name = "UPP Survey Ship"
	class = "PCV"
	desc = "The Galga-class Surveyor is a very recent design, created as apart of a joint Union venture between Xanu and Himeo, in an effort to better map out the Weeping Stars. Created to be largely self sufficient, its on board refinery allows it to create products for market between ventures into the uncharted areas of the Spur. While the ship is armed, its thin hull, powerful thrusters, and large fuel tanks encourage retreat."
	icon_state = "tramp"
	moving_state = "tramp_moving"
	colors = list("#8492fd", "#4d61fc")
	designer = "Union of Progressive Peoples, New Xanadu"
