...
/datum/ghostspawner/human/gadpathur_patrol/medical
	...
	welcome_message = "You are a detached member of one of the medical cadres of the United Planetary Defense Council of Gadpathur. You have been assigned as the surgeon of this crew. Your experience confers you with a higher rank than most of the crew, but you are not a section leader; you are a healer first, a soldier second."
