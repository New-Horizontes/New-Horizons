/datum/ghostspawner/human/kataphract
	...
	desc = "A Zo'saa (squire) of the traveling Kataphract Guild. Display honour in everything you do. Be an excellent person. Listen to the Saa's (Knights). Remember, you serve the Hegemony."
	tags = list("External")
...
/datum/ghostspawner/human/kataphract/klax
	...
	desc = "A Zo'saa (squire) from the K'lax Hive, here to learn what it means to be honourable. Remember, you serve the Hegemony on behalf of your K'laxan compatriots."
	max_count = 1
...
/datum/ghostspawner/human/kataphract/specialist
	...
	desc = "A Saa (Knight) of the traveling Kataphract Guild. Display honour in everything you do. Support your Knight Captain and lead by example. Remember, you serve the Hegemony."
	max_count = 1
