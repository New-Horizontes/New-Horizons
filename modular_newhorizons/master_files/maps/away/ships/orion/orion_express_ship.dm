/datum/map_template/ruin/away_site/orion_express_ship
	name = "Charon Shipping Mobile Station"
	description = "The Traveler-class mobile station is a relatively old design, but nonetheless venerable and one of the building blocks of interstellar commerce. While relatively small, is a treasured asset in the Charon Shipping Services corporation's fleet, and has been referred to as “the gas station of the stars”, offering food, supplies, and fuel to anyone who may need it."
...
/singleton/submap_archetype/orion_express_ship
	map = "Charon Shipping Mobile Station"
...
/obj/effect/overmap/visitable/ship/orion_express_ship
	...
	designer = "Charon Shipping, Refurbished Design"
	...
	initial_restricted_waypoints = list(
		"Charon Shipping Shuttle" = list("nav_hangar_orion_express")
	)
...
/obj/effect/overmap/visitable/ship/landable/orion_express_shuttle
	...
	desc = "The Troubadour-class skiff is not quite an independent design, and is instead essentially a component of the larger Traveler-class station as a whole, seamlessly attaching and detaching for operations as is necessary. This one's transponder identifies it as part of an Charon Shipping refueling station."
	shuttle = "Charon Shipping Shuttle"
	icon_state = "shuttle"
...
/obj/machinery/computer/shuttle_control/explore/orion_express_shuttle
	...
	shuttle_tag = "Charon Shipping Shuttle"
...
/obj/effect/shuttle_landmark/orion_express_shuttle/hangar
	name = "Charon Shipping Shuttle Hangar"
