...
/datum/ghostspawner/human/orion_express_courier
	...
	name = "Charon Shipping Station Crew"
	desc = "Crew the Charon Shipping mobile refueling station."
	tags = list("External")
	...
	assigned_role = "Charon Shipping Courier"
	special_role = "Charon Shipping Courier"
	respawn_flag = null


/datum/outfit/admin/orion_express_courier
	name = "Charon Shipping Courier"
...
/datum/ghostspawner/human/orion_express_courier/captain
	...
	name = "Charon Shipping Captain"
	desc = "Pilot and command the Charon Shipping mobile refueling station."
	tags = list("External")
	...
	assigned_role = "Charon Shipping Captain"
	special_role = "Charon Shipping Captain"
...
/obj/item/clothing/under/rank/hangar_technician/orion/ship
	name = "charon shipping courier uniform"

/obj/item/clothing/under/rank/operations_manager/orion_ship
	name = "charon shipping captain uniform"

/obj/item/card/id/orion_ship
	name = "charon shipping ship id"
