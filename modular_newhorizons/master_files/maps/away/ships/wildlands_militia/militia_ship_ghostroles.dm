/datum/ghostspawner/human/militia_crew
	...
	name = "Militiaman"
	desc = "Crew the militia ship. Help those that need it, try to keep your slice of space clean and safe of anyone the colonial governments and the Protectorate miss - there are people counting on you. Double as a hired gun, to make a few bucks."
	tags = list("External")
...
/datum/ghostspawner/human/militia_crew/captain
	...
	desc = "Captain the militia ship. Help those that need it, try to keep your slice of space clean and safe of anyone the colonial governments and the Protectorate miss - there are people counting on you. Double as a hired gun, to make a few bucks."
