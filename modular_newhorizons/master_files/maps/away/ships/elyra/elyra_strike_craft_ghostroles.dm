...
/datum/ghostspawner/human/elyran_naval_infantry
	...
	desc = "Crew the Elyran naval infantry interdiction craft. Follow your Ensign's orders. (OOC Note: All characters must be of Elyran ethnic origin and background.)"
	tags = list("External")
...
/datum/ghostspawner/human/elyran_naval_infantry/officer
	...
	desc = "Command and pilot the Elyran naval infantry strike craft. (OOC Note: All characters must be of Elyran ethnic origin and background.)"
	mob_name_prefix = "ENS. "
...
/datum/ghostspawner/human/elyran_naval_infantry/nco
	...
	desc = "Lead the Elyran naval infantry strike craft's riflemen. Serve as the Ensign's second-in-command, and follow their orders. (OOC Note: All characters must be of Elyran ethnic origin and background.)"
	mob_name_prefix = "PO3. "
