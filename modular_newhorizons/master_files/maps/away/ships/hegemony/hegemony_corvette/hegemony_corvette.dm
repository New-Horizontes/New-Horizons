...
/obj/effect/overmap/visitable/ship/hegemony_corvette
	...
	desc = "The Foundation-class corvette is the backbone of the Unathi Hegemony Navy, especially as many of their larger ships cannot operate without ready supplies of phoron. Foundation-class vessels are often seen patrolling the Badlands and Sparring Sea, to secure Hegemony trade routes against pirate incursion."
...
/obj/effect/overmap/visitable/ship/landable/hegemony_shuttle
	...
	desc = "The Hunter-class shuttle is the standard troop transport of the Hegemony, usually found attached to their smaller naval ships. While it is unarmed, it is agile, and armored for aggressive boarding maneuvers."
	icon_state = "shuttle"
