...
/datum/ghostspawner/human/izweski
	...
	desc = "You are a sworn warrior of the Hegemony Navy, your life and honor pledged to the homeworld. Abide by the Warrior's Code, and follow the orders of your superior officers. Remember, you serve the Hegemony."
	tags = list("External")
	...
	welcome_message = "As an Unathi warrior, abide by the Warrior's Code - act with righteousness, mercy, integrity, courage and loyalty. Defend the life and honor of Hegemony citizens, and ensure that enemies of your people cannot threaten your vessel."

	outfit = /datum/outfit/admin/izweski
	possible_species = list(SPECIES_UNATHI)
	allow_appearance_change = APPEARANCE_PLASTICSURGERY
	assigned_role = "Hegemony Navy Crewman"
	special_role = "Hegemony Navy Crewman"
	respawn_flag = null
...
/datum/ghostspawner/human/izweski/klax
	...
	desc = "You are a Warrior of the Hive K'lax, assigned to serve with the Hegemony Navy. Follow the orders of your superiors, and act to ensure the Hegemony's victory over its enemies."
	max_count = 1
...
/datum/ghostspawner/human/izweski/captain
	...
	desc = "You are an officer in the Hegemony Navy, your life and honor pledged to the Homeworld. Abide by the Warrior's Code, and lead your crew with honor. Remember, you serve the Hegemony."
	max_count = 1
	uses_species_whitelist = TRUE
	outfit = /datum/outfit/admin/izweski/captain
	assigned_role = "Hegemony Navy Captain"
	special_role = "Hegemony Navy Captain"
...
/datum/ghostspawner/human/izweski/specialist
	...
	desc = "You are a specialist in the Hegemony Navy, your life and honor pledged to the Homeworld. Act as the right hand of your captain, and always abide by the Warrior's Code. Remember, you serve the Hegemony."
	max_count = 1
	assigned_role = "Hegemony Navy Specialist"
	special_role = "Hegemony Navy Specialist"
	mob_name_prefix = "Ens. "

/datum/ghostspawner/human/izweski/warpriest
	short_name = "heg_pri"
	name = "Hegemony Navy Warpriest"
	desc = "You are an Ensiite Priest of the Warrior, serving as an officer with the Hegemony Navy. Ensure that the warriors on your vessel abide by the Warrior's Code, and call upon the God-Kings to bless your crew against harm. Remember, you serve the Hegemony and Ensi above all."
	max_count = 1
	uses_species_whitelist = TRUE
	...
	welcome_message = "As an Ensi Worship Priest, you are sworn more than any others to embody the honor of the God-Kings of Moghes in battle, and to live by the Warrior's Code - to act with righteousness, mercy, integrity, courage and loyalty. Ensure that your crew does the same, \
	and guide their souls towards te glory befitting true warriors of the Homeworld. However, you are still a soldier, and should follow your captain's orders."

/datum/outfit/admin/izweski
	name = "Hegemony Crewman"
