...
/singleton/submap_archetype/merchants_guild
	...
	descriptor = "A freighter flying under the banner of the Hegemony Merchants' Guild."

/obj/effect/overmap/visitable/ship/merchants_guild
	name = "Merchants' Guild Freighter"
	desc = "The Azkrazal-class freighter is a common civilian design from the Hegemony's shipbuilding guilds, designed in collaboration with Hephaestus Industries. They are mostly found in the possession of Unathi guilds, as well as the occasional smuggler or pirate fleet."
	class = "UHGV" //Unathi Hegemony Guild Vessel
	icon_state = "tramp"
	...
	designer = "Hephaestus Industries, Hegemonic Naval Guilds"
...
/obj/effect/overmap/visitable/ship/landable/merchants_guild_shuttle
	...
	desc = "A Seeker-class transportation shuttle, manufactured in the Hegemony. The design is small and somewhat cramped, but it is cheap to manufacture and maintain."
	icon_state = "shuttle"
