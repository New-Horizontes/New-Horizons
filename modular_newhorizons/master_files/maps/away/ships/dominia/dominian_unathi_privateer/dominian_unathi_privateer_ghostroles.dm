/datum/ghostspawner/human/kazhkz_privateer
	...
	name = "Clan Kazhkz Privateer"
	desc = "You are a privateer of the Dominian-supporting Unathi Clan Kazhkz - sent into the Badlands to pillage and harass the enemies of the Empire and the Kazhkz-Han'san. Vessels of the Serene Republic of Elyra, the Coalition of Independent Colonies, and the Unathi Hegemony are particularly prized targets by the Kazhkz."
	tags = list("External")
	...
	welcome_message = "You are a privateer of the Clan Kazhkz Fleet - a plausibly deniable weapon of House Borgia of the Empire of Dominia, sent to scourge the Emperor's enemies in the Sparring Sea and Badlands. Though the two empires are not enemies, the Kazhkz bear a particular enemy for the Unathi Hegemony, and will often attack their vessels."
...
/datum/ghostspawner/human/kazhkz_privateer/captain
	...
	name = "Clan Kazhkz Privateer Captain"
	desc = "You are a captain of the Dominian-supporting Unathi Clan Kazhkz - placed in command of a vessel by your sponsors in House Borgia and sent into the Badlands to pillage and harass the enemies of the Empire and the Kazhkz-Han'san. Vessels of the Serene Republic of Elyra, the Coalition of Independent Systems, and the Unathi Hegemony are particularly prized targets by the Kazhkz."
	tags = list("External")
	mob_name_suffix = " Kazhkz"
	mob_name_pick_message = "Pick an Unathi first name."
