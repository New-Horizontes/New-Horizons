/datum/map_template/ruin/away_site/dominian_corvette
	...
	description = "One of the most common ships in the Imperial Fleet, Lammergeier-class corvettes are often used as the vanguard of battlefleets entering a system marked for annexation into the glorious Empire as it is tasked to find and scout routes for the larger fleet. Though intended for scouting and screening work the Lammergeier is, like its larger counterparts, quite heavily armed and armored for a typical corvette. Any frontier savages who attempt to meet one with force of arms will soon find themselves staring down the barrels of Merebyrgenn’s finest weaponry, and the Fleet-trained crew entrusted to operate it. The heavy armament and sensors of the Lammergeier-class come at a cost: it lacks a shield generator and is much larger than a typical Solarian corvette, thus requiring a larger crew. Lammergeier-class captains are generally loyal citizens of the Empire, such as those of Novi Jadran, and are authorized to take whatever measures are necessary to ensure their crew remains loyal to both Empire and Dynasty. This one’s transponder marks it as belonging to the Empire’s First Battlefleet – a battle-hardened formation responsible for patrolling the region of the northern Sparring Sea between the Empire, Hegemony, and Protectorate."
...
/obj/effect/overmap/visitable/ship/dominian_corvette
	...
	designer = "Merebyrgenn Naval Arsenal, Empire of Dominia"
