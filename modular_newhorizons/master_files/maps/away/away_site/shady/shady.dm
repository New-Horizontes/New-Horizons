...
/obj/item/paper/shady/printedmessage
	name = "printed paper"
	info = "The target is a Charon Shipping transport vessel. And get this, our little bird says it has twenty canisters of phoron on it. Onboard security has already been bribed, easy in and out gig for you and your crew. We'll send you their schedule tomorrow, be ready."
