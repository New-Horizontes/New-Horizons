/datum/ghostspawner/human/tarwa
	...
	desc = "You are a pirate, serving with the enigmetic Tarwa Conglomerate - also called the living-dead fleet. Obey your captain, defend your ship and crew, and survive another day."
	tags = list("External")
...
/datum/ghostspawner/human/tarwa/diona
	...
	desc = "You are a diona gestalt serving with the pirate crew of the Tarwa Conglomerate, and likely grown among their number. Obey your captain, defend your ship and crew, and survive another day."
	max_count = 1
...
/datum/ghostspawner/human/tarwa/captain
	...
	desc = "You are the captain of a pirate crew of the Tarwa Conglomerate - also called the living-dead fleet. Lead your crew to profit and glory, for the sake of your fleet."
	max_count = 1
	uses_species_whitelist = TRUE
