/datum/ghostspawner/human/izharshan
	...
	desc = "Quartermaster, Vesselhide, Gunner or mere Crew, whatever your role is, you will obey your captain, for your pirate clan and fleet, the Izharshan."
	tags = list("External")
...
/datum/ghostspawner/human/izharshan/captain
	...
	desc = "Lead your ship for the honor and wealth of pirate clan and fleet Izharshan. Your ship has poor side armor, so be careful threatening ships with bigger guns, but your flechettes can intimidate the rest. If all else fails, you can bring the entire ship into boarding range."
	max_count = 1
