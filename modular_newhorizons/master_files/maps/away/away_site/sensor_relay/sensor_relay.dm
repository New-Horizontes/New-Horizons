/datum/map_template/ruin/away_site/sensor_relay
	name = "sensor relay"
	description = "A ring-shaped installation with a powerful sensor suite. These stations were originally built during the Interstellar Exploration era by the United Nation’s Interstellar Colonization Effort as a method of making interstellar travel safer. Thousands of these “beacon stations” were built by the UN and many were abandoned during the colonial independence era. While they have been mostly replaced in more developed sectors, such as Liberty’s Cradle and the Jewel Worlds, beacon stations are still a common sight in less developed sectors of the Orion Spur such as the Badlands and Weeping Stars."
