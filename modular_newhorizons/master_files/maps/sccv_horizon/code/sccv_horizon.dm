/datum/map/sccv_horizon
	name = "UNPV Horizon"
	full_name = "United Nations Protectorate Peacekeeper Vessel Horizon"
	path = "sccv_horizon"
	...
	station_name = "UNPV Horizon"
	station_short = "Horizon"
	dock_name = "Protectorate Docking Post - Aurora"
	dock_short = "Protectorate Docking Post"
	boss_name = "United Nations Interstellar Protectorate"
	boss_short = "UNIP"
	company_name = "Office of Special Services"
	company_short = "OSS"
	station_type = "ship"

	command_spawn_enabled = TRUE
	command_spawn_message = "Welcome to the UNPV Horizon!"
	...
	emergency_shuttle_docked_message = "Attention all hands: the emergency evacuation sequence has started. You have approximately %ETA% minutes to board the emergency pods."
	emergency_shuttle_leaving_dock = "Attention all hands: the emergency evacuation sequence has been completed. All lifepods launched."
	emergency_shuttle_recall_message = "Attention all hands: the emergency evacuation sequence has been canceled."
	emergency_shuttle_called_message = "Attention all hands: a full emergency evacuation has been called, this is not a drill. Ship evacuation sequence will start in approximately %ETA%."
...
/datum/map/sccv_horizon/send_welcome()
	...
	var/welcome_text = "<center><img src = scclogo.png><br />[FONT_LARGE("<b>UNIPS Horizon</b> Ultra-Range Sensor Readings:")]<br>"
	...
	post_comm_message("UNPV Horizon Sensor Readings", welcome_text)
