...
https://github.com/New-Horizontes/New-Horizons/pull/<!--PR Number-->
...
E.g:
- `modular_newhorizons/master_files/sound/my_cool_sound.ogg`
- `modular_newhorizons/master_files/code/my_modular_override.dm`: `proc/overriden_proc`, `var/overriden_var`
-->
